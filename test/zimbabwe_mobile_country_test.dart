...
void main() {
  group('ZimbabweMobileCountry Tests', () {
    final zimbabweMobileCountry = ZimbabweMobileCountry();
    ...
    test('check invalid Zimbabwe mobile number format', () {
      expect(zimbabweMobileCountry.checkFormat('26377123456'), isFalse); // too short
      expect(zimbabweMobileCountry.checkFormat('2637712345678'), isFalse); // too long
      expect(zimbabweMobileCountry.checkFormat('771234567'), isFalse); // missing country code
      expect(zimbabweMobileCountry.checkFormat('26A771234567'), isFalse); // non-digit
    });

    test('format Zimbabwe mobile number', () {
      expect(zimbabweMobileCountry.formatMobile('263771234567'), '(263) 771-234567');
      expect(zimbabweMobileCountry.formatMobile('+263 771 234 567'), '(263) 771-234567');
